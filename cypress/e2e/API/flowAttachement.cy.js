...
{
    let token,caseno,caseID, fileName, maintestid
    ...
    it.only('uploads a file with an attachment type via API',function(){
        ...
        cy.fixture(fileName).then(fileContent => {
          ...
          cy.request({
            method: 'POST',
            url: 'http://10.10.10.239:8082/case-api/v1/flowcytometry/flowcytometryanalysis/upload/'+maintestid, 
            headers: {
                Authorization: 'Bearer '+ token
                        },
    ...
    it.only('Get flow cyto Analysis',function()
    {
        ...
        cy.request({
            method: 'GET',
            url: 'http://10.10.10.239:8082/case-api/v1/flowcytometry/flowcytometryanalysis/'+caseID,
    ...
    it.only('Download flow cytometry analysis',function()
    {
        ...
        cy.request({
            method: 'GET',
            url: 'http://10.10.10.239:8082/case-api/v1/flowcytometry/flowcytometryanalysis/'+caseno+'/'+fileName,
    ...
    it.only('Delete Case Attachement',function()
    {
        ...
        cy.request({
            method: 'DELETE',
            url: 'http://10.10.10.239:8082/case-api/v1/flowcytometry/flowcytometryanalysis/'+maintestid+'/'+fileName,
